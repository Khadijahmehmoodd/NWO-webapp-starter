  ...
  return (
    <section className="w-full px-4 py-16">
      ...
      <div className="relative">
        <div
          ref={scrollRef}
          className="flex gap-4 overflow-x-auto sm:overflow-visible no-scrollbar scroll-snap-x scroll-snap-mandatory px-2 pb-6"
        >
          {products.map((item, idx) => (
            <div
              key={idx}
              className="scroll-snap-start min-w-full sm:min-w-0 sm:flex-1 max-w-[300px] bg-canvas-on-canvas rounded-md p-4 flex-shrink-0 cursor-pointer group transition duration-300"
            >
